...
namespace spi {
  ...
  public:
    /**
     * @brief Construct a new Chip Select Pin object.
     * @param port GPIO port of the CS pin.
     * @param pin GPIO pin number of the CS pin.
     */
   ...
   */
  bool write(SPI_TypeDef* spi_x, uint16_t reg, const uint8_t* data, uint16_t len, uint32_t timeout);
